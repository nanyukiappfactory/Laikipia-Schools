    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-5">
                <ul class="list-unstyled list-inline social text-center">
                    <li class="list-inline-item"><a href="javascript:void();"><i class="fab fa-facebook-square"></i></a>
                    </li>
                    <li class="list-inline-item"><a href="javascript:void();"><i class="fab fa-twitter-square"></i></a>
                    </li>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2">
                <p class="text-center"><u><a href="#">Laikipia Schools</a></u> is an initiative of the Laikipia County
                    Government</p>
                <p class="h6 text-center">&copy All right Reversed.<a class="text-green ml-2"
                        href="https://appfactory.mawingunetworks.com" target="_blank">Nanyuki AppFactory</a></p>
            </div>
            </hr>
        </div>
    </div>
...
<script src="<?php echo base_url(); ?>assets/themes/website/assets/vendor/magnific-popup/libs/jquery/jquery.js"></script>
...
<script src="<?php echo base_url(); ?>assets/themes/website/assets/vendor/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
...
<script type="text/javascript">
		$(document).ready(function () {
			...
			$('.schoolGalleryCarousel').magnificPopup({
